...
DELETE FROM user_order_quantities;
...
INSERT INTO user_order (address_id, user_id) VALUES (@address1, @userId1);
INSERT INTO user_order (address_id, user_id) VALUES (@address1, @userId1);
INSERT INTO user_order (address_id, user_id) VALUES (@address1, @userId1);
INSERT INTO user_order (address_id, user_id) VALUES (@address2, @userId2);
INSERT INTO user_order (address_id, user_id) VALUES (@address2, @userId2);

SET @order1 := (SELECT id FROM user_order WHERE address_id = @address1 AND user_id = @userId1 ORDER BY id DESC LIMIT 1);
SET @order2 := (SELECT id FROM user_order WHERE address_id = @address1 AND user_id = @userId1 ORDER BY id DESC LIMIT 1 OFFSET 1);
SET @order3 := (SELECT id FROM user_order WHERE address_id = @address1 AND user_id = @userId1 ORDER BY id DESC LIMIT 1 OFFSET 2);
SET @order4 := (SELECT id FROM user_order WHERE address_id = @address2 AND user_id = @userId2 ORDER BY id DESC LIMIT 1);
SET @order5 := (SELECT id FROM user_order WHERE address_id = @address2 AND user_id = @userId2 ORDER BY id DESC LIMIT 1 OFFSET 1);

INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order1, @product1, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order1, @product2, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product3, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product2, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order2, @product5, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order3, @product3, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order4, @product4, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order4, @product2, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order5, @product3, 5);
INSERT INTO user_order_quantities (order_id, product_id, quantity) VALUES (@order5, @product1, 5);